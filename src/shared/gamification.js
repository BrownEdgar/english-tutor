...
export const DAILY_PHRASES = [
  {
    ...
    armenianNote:
      'Armenians often say "How?" literally — but "What\'s up?" is purely idiomatic.',
  },
  {
    ...
    armenianNote:
      'Notice the article "a bit" — Armenian doesn\'t require this filler but English does for softening.',
  },
  {
    ...
    armenianNote:
      '"Do me a favour" — note the article "a". Never say "Do me favour."',
  },
  {
    ...
    armenianNote:
      'This idiom works identically in Armenian! "Lеzvi tsayrіn em" — a rare direct match.',
  },
  {
    ...
    armenianNote:
      'Armenian business culture often says "կapaktsnenk" but "touch base" is the English equivalent.',
  },
  {
    en: "I'm all ears.",
    hy: 'Ամem dum em:',
    ...
    armenianNote:
      'Note: "I\'m all ears" not "I am listening" — idioms can\'t be translated literally.',
  },
  {
    ...
    armenianNote:
      'Don\'t say "How write it?" — use "How do you spell...?" with the full question structure.',
  },
  {
    ...
    armenianNote:
      'Use "Could you" not "Can you" in formal contexts — "Could" is more polite.',
  },
  {
    ...
    armenianNote:
      'Armenians tend to say "Yerek vayrkyan" (one moment) — "Bear with me" sounds much more professional.',
  },
  {
    ...
    armenianNote:
      'The closest Armenian equivalent is "ays bzhshkutyan ch\' e" but "rocket science" is the English standard.',
  },
  {
    en: 'He has a point.',
    ...
    armenianNote:
      'Article alert: "has A point" — never "has point". Armenians frequently drop this "a".',
  },
  {
    ...
    armenianNote:
      "This uses Present Perfect Continuous — a tense Armenian doesn't have directly.",
  },
  {
    ...
    armenianNote:
      'Sport idioms are very common in English. Learn them in context, not word by word.',
  },
  {
    ...
    armenianNote:
      'Armenians often say "shad ashkhatum em" (very busy) — "swamped" adds emotional intensity.',
  },
  {
    ...
    armenianNote:
      'Don\'t say "this calls my bell" — it\'s "rings A bell" with the article.',
  },
  {
    ...
    armenianNote:
      '"Pick your brain" — don\'t try to translate this literally. Learn it as a fixed chunk.',
  },
  {
    ...
    armenianNote:
      '"On the fence" has no Armenian idiom equivalent — translate the meaning, not the words.',
  },
  {
    ...
    armenianNote:
      'Armenian has a similar phrase! "Мi akhov mtes, mekin akhov yrets" — a nice connection to make.',
  },
  {
    ...
    armenianNote:
      'Very important in business English. Never say "I will answer to you later" — say "get back to you".',
  },
  {
    ...
    armenianNote:
      'Note the article "a compelling argument" — not "compelling argument". The "a" is essential.',
  },
  {
    ...
    armenianNote:
      'Armenian idiom: "Patmutyun mi sареk" (don\'t tell a story) is similar in meaning.',
  },
  {
    ...
    armenianNote:
      'Armenian SOV word order often causes Armenians to put the verb last — English is SVO: Subject-Verb-Object.',
  },
  {
    ...
    armenianNote:
      'The past continuous "was wondering" makes requests softer — a critical politeness tool in English.',
  },
  {
    ...
    armenianNote:
      'Armenian has "Ashkharhum dzer qayleri vray char en" but "easier said than done" is THE idiom to know.',
  },
  {
    ...
    armenianNote:
      'This expression is 100% idiomatic — impossible to guess from individual words. Learn as a unit.',
  },
  {
    ...
    armenianNote:
      'Armenian equivalent: "Нuyн kachumne enk" (we\'re in the same cart) — boat vs cart, same concept!',
  },
  {
    ...
    armenianNote:
      '"Second thought" uses the ordinal — "second", not "two". Ordinals in English are a common Armenian learner error.',
  },
  {
  ...
  },
  {
    ...
    armenianNote:
      'One of the most useful C1 idioms for scepticism. Armenian has no direct equivalent.',
  },
  {
    ...
    armenianNote:
      '"Call it a day" — notice the article "a day". Essential phrase for any workplace situation.',
  },
];
